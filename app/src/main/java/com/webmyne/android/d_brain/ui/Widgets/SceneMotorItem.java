 ...
 */
public class SceneMotorItem extends LinearLayout{
    ...
    public SceneMotorItem(Context _context) {
        super(_context);
        this.mContext = _context;
        init(mContext);
    }

    public SceneMotorItem(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        this.mContext = context;
        init(mContext);
    }

    public SceneMotorItem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context) {
       /* inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        txtSwitchName.setText("Motor Name");
